...
define(['pipAPI'], function(APIconstructor) {
	...
	API.addTrialSets('base',[{
		...
		input: [
			...
			{handle:'cisgender', on:'leftTouch', stimHandle:'left'},
			{handle:'transgender', on:'rightTouch', stimHandle:'right'}
		],
		layout: [
			{media:{word:'Press the right side of the screen for transgender and the left side of the screen for cisgender'}, css : {color:'black'}, location:{bottom:0}},
		...
		input: [
			{handle:'space',on:'bottomTouch', css:{}}
		],
		interactions: [
			{ // begin trial
				conditions: [{type:'begin'}],
	...
	API.addSequence([
		{
			...
			stimuli: [
				...
				'<br/>' +
				'Please place one finger on the left side of the screen and another finger on the right side of the screen. ' +
				'If the person is transgender, press the right side of the key. If the person is cisgender, press the left side of the key. ' +
				'Images will apear one at a time.<br/><br/>' +
				'<p align="center">Press the bottom of this screen to begin.</p>' +
			'</div>'},
		...
		},
		{
			...
			stimuli: [
				{
					media:{word:'You have finished this portion of the study. Touch the bottom of the screen to continue.'}, 
					css : {color:'black', padding:'3%'}
				}
			]			
		}
